...
validation_image_start  = "examples/1.png"
validation_image_end    = "examples/2.png"

# prompts
prompt = "robotic arms are assembling a car in a factory. The scene is filled with advanced machinery and technology, showcasing the efficiency of modern manufacturing. The lighting is bright and the atmosphere is busy, with workers in the background overseeing the process. The car being assembled is sleek and futuristic, with a shiny metallic finish."
...
lora_weight         = 0.55
save_path           = "samples/omniverse_ai_curation_output"
